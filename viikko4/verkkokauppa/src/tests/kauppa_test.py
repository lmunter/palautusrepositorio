...
class TestKauppa(unittest.TestCase):
    ...
    def test_tilisiirtoa_kutsutaan_oikeilla_parametreilla_kun_ostetaan_useampi_tuote(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilisiirtoa_kutsutaan_oikeilla_parametreilla_kun_ostetaan_kaksi_samaa_tuotetta(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilisiirtoa_kutsutaan_oikein_kun_ostetaan_tuotetta_joka_on_loppu(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_aloita_asiointi_metodi_tyhjentaa_ostoskorin(self):
        pankki_mock= Mock()
        viitegeneraattori_mock = Mock()
        viitegeneraattori_mock.uusi.return_value = 42
    ...
    def test_viitegeneraattori_antaa_aina_uuden_viitenumeron(self):
        pankki_mock= Mock()
